...
//! nothing else - no line numbers, no pairing of a removed line with the added
//! one that replaced it - because the interface draws one unified list, and a
//! pairing nobody asked for would be a second thing to be wrong about.
//!
